...
- **File Watching Details**: ~~What debounce interval?~~ 100ms. See [[Decision - Graphology Lifecycle]]. Still open: How to handle partial reads during write? `.roux/` ignored automatically?
