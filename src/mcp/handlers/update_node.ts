...
export const schema = {
  ...
  properties: {
    id: {
      type: 'string',
      description:
        'Node ID to update. Accepts either a stable nanoid (e.g., "abc123XYZ789") or a file path for backwards compatibility (e.g., "recipes/bulgogi.md"). Paths are normalized to lowercase. Prefer nanoid for direct lookup; path requires index scan.',
    },
    title: {
      type: 'string',
